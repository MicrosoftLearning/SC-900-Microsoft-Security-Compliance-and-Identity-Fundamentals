...
1. Select the first option, **Create Cloud Discovery snapshot report**. Here you would fill in the requested details and upload tariff logs to generate and upload a report.  Select **Cancel**.  The data you are seeing for your lab tenant came from a Snapshot report, you can see this information on the top right corner of the screen.
...
2. From this policy window on the top right of the page, select ****View open alerts**.  Note how the Alerts option in the left navigation panel is now selected.  This is simply a different wayd to get to the alerts page.
