...
## Lab scenario
In this lab you will walk through Intune in Microsoft Endpoint Manager. Note: no endpoints or devices are configured in this lab instance, so this walk through will not show any actual endpoint information. This walkthrough serves only to guide the learner on the information that would be available and where to find that information.  For a more detailed walk through refer to the video (https://www.microsoft.com/en-us/videoplayer/embed/RE4LTIu) in the associated Learn content.


**Estimated Time**: 00 minutes

#### Task: In this task you will walk through Intune in Microsoft Endpoint Manager.
...
#### Review
In this lab you walked through Intune in Microsoft Endpoint Manager. Note: no endpoints or devices are configured in this lab instance, so this walk through will not show any actual endpoint information. This walkthrough serves only to guide the learner on the information that would be available and where to find that information.  For a more detailed walk through refer to the video (https://www.microsoft.com/en-us/videoplayer/embed/RE4LTIu) in the associated Learn content.
