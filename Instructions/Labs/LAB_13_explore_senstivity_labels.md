...
1. First make sure you have Office setup on your lab virtual machine (VM).  To do this, select the **Microsoft 365 admin center** tab that is open the browser.  If you previously closed the tab, open a new browser tab and enter **admin.microsoft.com**.
    1. From the left navigation panel select **Billing** to view all the options then select **Your products**.
    1. From the Your products page, select **Microsoft 365 E5 Trial**
    1. From the Microsoft 365 E5 Trial page, select **Download and install software** and follow the instructions on the page.

1. From the bottom left corner of the lab VM , select the Windows icon, then select **Word** then select **Blank document**.  This will open a new word document using the desktop version of Word.

1. From the top menu bar, select **Sensitivity**. From the drop down select **Confidential - Finance**.

1. Notice how the document includes the watermark.  The watermark will appear in small, light gray text displayed vertically on the page. 
