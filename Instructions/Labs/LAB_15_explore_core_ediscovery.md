...
lab:
  ...
  description: In this lab, you walk through the steps required to get started with eDiscovery, including setting up the role permissions for eDiscovery and creating an eDiscovery case. With the case, created you explored the settings for creating search and exporting results, adding to a review set, and creating a hold.
  duration: 45 minutes
  level: 200
  islab: true
---
